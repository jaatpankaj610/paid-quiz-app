...
# --- 3. FAKE WEB SERVER (Render को Live रखने के लिए) ---
...
if __name__ == '__main__':
    # वेब सर्वर को अलग धागे (Thread) में चलाना ताकि Render को "Live" मिले
